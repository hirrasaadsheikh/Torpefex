            ...
            <View style={styles.Container}>
                ...
                <View style={styles.Card}>
                    <View style={{width: "100%", height:"10%",justifyContent:"center"}}>
                        <Text style={{textAlign:"center",fontSize:22, fontFamily: 'sans-serif-medium'}}>Sign Up</Text>
                    </View>
                    <View style={{width:"100%",height:"90%",justifyContent:"center"}}>
                        ...
                        <View style={{flexDirection:"row",alignSelf: "center",marginTop: "10%"}}>
                            ...
                            <Text style={{color:"#9E1774"}} onPress={()=>this.props.navigation.navigate("Login")}>Sign In</Text>
                        </View>
